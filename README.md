...
<p align="center">
  <em>"Acredito que um código bem escrito é a chave para criar soluções robustas que geram um impacto positivo na experiência do usuário."</em>
</p>
...
- **Backend com Node.js e Express**: Criando **APIs RESTful** escaláveis com **JWT**, **Prisma**, **Knex**, com integrações contínuas em **PostgreSQL** e **MySQL**.
...
A cada dia que passa venho aprimorando minhas habilidades tanto no **backend** quanto no **frontend**, com ênfase em performance e escalabilidade.

**Minhas principais habilidades incluem**:

- **Backend**: Node.js, Express, Prisma, Knex, Java, Springboot, PostgreSQL, MySQL.
...
<p align="center">
  Sempre me aperfeiçoando e dedicando muitas horas em códigos de maneira prática.
</p>
